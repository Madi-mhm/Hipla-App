...
export default function SeanceHebdo({ seance, peutAgir = true }: {
  seance: Seance;
  /** Valider et confirmer : réservé aux rôles qui en ont le droit. */
  peutAgir?: boolean;
}) {
      ...
      {seance.creation && Number(seance.creation.lignes) > 0 && (
        <div className="card" style={{ marginBottom: '1.25rem' }}>
          ...
          <div style={{ marginTop: '.9rem' }}>
            <Link href="/depenses/creation" className="btn btn--ghost">
